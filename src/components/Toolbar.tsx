...
import { ArrowUpRight, Edit2, MousePointer, PenTool, Square, X, User, Users } from 'react-feather'
  ...
  return (
    <ToolbarContainer>
      <PrimaryTools>
        ...
        <PrimaryToolButton id="person" isActive={machine.isIn('person')} onClick={onToolSelect} title="Add SVG wo Viewbox">
          <Highlight>
            <User />
          </Highlight>
        </PrimaryToolButton>
        <PrimaryToolButton id="vperson" isActive={machine.isIn('vperson')} onClick={onToolSelect} title="Add SVG with ViewBox">
          <Highlight>
            <Users />
          </Highlight>
        </PrimaryToolButton>
